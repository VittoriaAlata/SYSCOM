...
class SYSCOM
{
    static void Main(string[] args)
    {
        ...
        //Application.Current.KeyDown += (sender, args) =>
        //{
        //    Console.WriteLine($"Key pressed: {args.KeyEvent.Key}");
        //    if (args.KeyEvent.Key == Key.Q)
        //    {
        //        Application.RequestStop();
        //    };
        //    if (args.KeyEvent.Key == Key.F)
        //    {
        //        Application.Driver.SendKeys('F', ConsoleKey.Tab, false, false, false);
        //    }
        //};

        //Application.Current.key

        //Application.Current.KeyPress
        //Application.Driver.SendKeys('F', ConsoleKey.Tab, false, false, false);
        ...
        Window win = new Window()
        {
            ...
            Width = 65,
            Height = 22,
            ColorScheme = DiagColorScheme.Scheme.ColorDiag //schema dei colori utilizzato nella finestra MAIN
        };
